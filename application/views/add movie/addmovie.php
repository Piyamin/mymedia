                        ...
                        <div class="value">
                           <div class="input-group">
                              <input
                                 ...
                                 type="text"
                                 name="Director "
                                 placeholder="ปีที่เข้าฉาย (ระบุปี ค.ศ. โดยใส่แค่ตัวเลข)"
                                 />
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="value">
                           <div class="input-group">
                              <input
                                 ...
                                 type="text"
                                 name="Director "
                                 placeholder="ความยาวหนัง (ตัวอย่างเช่น 2:30:00)"
                                 />
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="value">
                           <div class="input-group">
                              <input
                                 ...
                                 type="text"
                                 name="Director "
                                 placeholder="(เช่น  https://www.youtube.com/watch?v=7SwuQWj-Xjw)"
                                 />
                           </div>
                        </div>
                     </div>
                        ...
                        <div class="value">
                           <div class="input-group">
                              <input
                                 ...
                                 type="text"
                                 name="Director "
                                 placeholder="(เช่น https://www.bloggang.com/data/onceupon/picture/1178453270.jpg)"
                                 />
                           </div>
                        </div>
                     </div>
